...
/*xxx*/
/* select char map (if available) */
extern DECLSPEC int SDLCALL TTF_SelectCharMap(TTF_Font *font, int platform_id, int encoding_id);
...
/*xxx*/
/* get FreeType Face from TTF_Font */
extern DECLSPEC FT_Face TTF_GetFreeTypeFace(TTF_Font *font);
